...
const faqs = [
  ['¿Debo agendar antes de llegar?', 'Sí. Lo ideal es escribir por WhatsApp para confirmar disponibilidad y recibir orientación previa.'],
  ['¿Dónde está ubicada la clínica?', 'En Centro Comercial Plaza Bernal, Edificio 1, Local 12, San Salvador.'],
  ['¿Atienden los sábados?', 'Sí. Los sábados atienden de 8:30 a.m. a 12:30 p.m.'],
  ['¿Qué servicios ofrecen?', 'Limpieza dental, blanqueamiento, ortodoncia, endodoncia, implantes y extracción dental.'],
  ['¿Puedo consultar primero por WhatsApp?', 'Sí. Puedes escribir para recibir información inicial y agendar tu evaluación.'],
  ['¿La evaluación es personalizada?', 'Sí. Cada caso se revisa para recomendar el tratamiento más adecuado.']
];
